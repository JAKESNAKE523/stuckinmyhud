...
__attribute__((used)) static BOOL _logos_method$Tweak$SBElasticVolumeViewController$alwaysSmall(SBElasticVolumeViewController * __unused self, SEL __unused _cmd) { NSValue * value = objc_getAssociatedObject(self, (void *)_logos_method$Tweak$SBElasticVolumeViewController$alwaysSmall); BOOL rawValue; [value getValue:&rawValue]; return rawValue; }; __attribute__((used)) static void _logos_method$Tweak$SBElasticVolumeViewController$setAlwaysSmall(SBElasticVolumeViewController * __unused self, SEL __unused _cmd, BOOL rawValue) { NSValue * value = [NSValue valueWithBytes:&rawValue objCType:@encode(BOOL)]; objc_setAssociatedObject(self, (void *)_logos_method$Tweak$SBElasticVolumeViewController$alwaysSmall, value, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
...
static void _logos_method$Tweak$SBElasticVolumeViewController$viewDidLoad(_LOGOS_SELF_TYPE_NORMAL SBElasticVolumeViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd){
  ...
  self.alwaysSmall = [[tweakSettings valueForKey:@"alwaysSmall"] isEqual:@1];

  if(!self.artworkFrame){
    NSInteger state = MSHookIvar<NSInteger>(self, "_state");
    RLog(@"%d", state);
    CGRect frame;
    if((state == 1 || state == 3) && !self.alwaysSmall){
